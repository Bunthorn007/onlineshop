...
<head>
    ...
    <meta charset="UTF-8">
    <title>Admin Upload Product Images - Onlineshop</title>
            ...
            <div class="signup">
                ...
                <div class="signup-body">
                    ...
                    <div class="row gutter-xs">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <a  href="{{url('/admin/product', $pid)}}" class="btn btn-primary btn-block"><span class="icon icon-check-square-o"></span>  Finish</a>
                            </div>
                        </div>
                    </div>
                </div>
