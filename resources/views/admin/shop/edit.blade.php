...
@section('header')
    <title>Admin Edit Shop - Onlineshop</title>
...
@section('content')
    ...
    <div class="signup">
        ...
        <div class="signup-body">
            ...
            <form action="{{url('admin/shop/'.$shop->id)}}" method="post" enctype="multipart/form-data" data-toggle="validator" data-groups='{"birthdate": "birth_month birth_day birth_year"}'>
                {{csrf_field()}}
