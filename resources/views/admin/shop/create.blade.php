...
@section('header')
    <title>Admin Create Shop - Onlineshop</title>
...
@section('content')
    ...
    <div class="signup">
        ...
        <div class="signup-body">
            ...
            <form action="{{url('admin/shop')}}" method="post" enctype="multipart/form-data" data-toggle="validator" data-groups='{"birthdate": "birth_month birth_day birth_year"}'>
                {{csrf_field()}}
                    ...
                    <div class="row gutter-xs">
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <select id="user" class="custom-select" name="user_id" data-msg-required="Please select user of shop." required>
                    ...
                    <div class="row gutter-xs">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <textarea id="content" rows="5" class="form-control" name="address" data-msg-required="Please enter your address." required></textarea>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="message">Message</label>
                                <textarea id="content" rows="5" class="form-control" name="message" data-msg-required="Please enter your message to customer." required></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row gutter-xs">
