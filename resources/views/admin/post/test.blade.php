            ...
            <div class="product">
                <div class="product-images">
                    <div class="flexslider">
                        <ul class="slides">
                            <li data-thumb="{{asset('img/6858253787.jpg')}}">
                                <img src="{{asset('img/6858253787.jpg')}}" alt="Sri Elephant T-shirt">
                            </li>
                            <li data-thumb="{{asset('img/6950484109.jpg')}}">
                                <img src="{{asset('img/6950484109.jpg')}}" alt="Sri Elephant T-shirt">
                            </li>
                            <li data-thumb="{{asset('img/6950484109.jpg')}}">
                                <img src="{{asset('img/6950484109.jpg')}}" alt="Sri Elephant T-shirt">
                            </li>
                ...
                <div class="product-details">
                    ...
                    <span class="icon icon-eye icon-lg icon-fw"></span>100 views
                    ...
                    <p style="padding-top: 15px;"><span class="icon icon-tags icon-lg icon-fw"></span> Phone</p>
