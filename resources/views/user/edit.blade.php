...
@section('header')
    <title>User Edit Profile - Onlineshop</title>
...
@section('content')
    <div class="signup">
        ...
        <div class="signup-body">
            ...
            <form method="post" action="{{url('/user/update/'.$user->id)}}" enctype="multipart/form-data" data-toggle="validator" data-groups='{"birthdate": "birth_month birth_day birth_year"}'>
                {{csrf_field()}}
